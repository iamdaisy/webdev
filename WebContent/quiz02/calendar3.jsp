...
<input type="hidden" name="addmonth" value="0" />
	...
	<table style="width:250px;"> 
		<caption>
			...
			<span onclick="func_addmonth(-1)" style="cursor:pointer;">◀</span><select name="year" onchange="document.myform.submit()">
				<%
			...
			</select>월<span onclick="func_addmonth(1)" style="cursor:pointer;">▶</span>
			<span onclick="func_addmonth(12)" style="cursor:pointer;">▷</span>
		</caption>
...
<%
	...
	for(int d=1, w=week; d <= end_day; d++, w++) {
		out.println("<td class='week'>" + d + "</td>");
